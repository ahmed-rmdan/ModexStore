...
dispatch(dialogactions.decreasepage())
 ...
 return(
       ...
       <div className="fixed w-full  items-center flex flex-col h-full z-[20000] bg-[#000000d5]">
              ...
              <div className="fixed flex flex-row justify-center items-center top-[10%] gap-[2%] h-[90%] w-[95%] ">
               ...
               <div className="flex flex-row overflow-hidden min-w-[73%] self-center max-w-[73%] h-[50%] sm:w-[60%] sm:h-[80%]">
