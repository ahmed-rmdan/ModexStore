...
export const Searchproduct:React.FC<{}>=()=>{
   ...
   function handleclick(){
    ...
    return(
                       ...
                       <div className="flex flex-row items-center  justify-center gap-[5%] h-[40px] sm:h-[50px] w-[75%] sm:w-[40%] xl:w-[30%]">
                                 <input type='text' placeholder="product name" className="w-[70%] h-[90%] text-[1.5em] sm:text-[1.1em] bg-white
