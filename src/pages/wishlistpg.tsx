                      ...
                      <AnimatePresence>
                       ...
                       : data?.length!==0?
                             ...
                             data?.products.map(elm=>{
                                   return   <Listitem key={elm.id} listtype="wishlist" type={elm.type} oldprice={elm.oldprice} price={elm.newprice} 
                               ...
                               :
                               <p className="text-purple-800 font-bold text-[3.5em]">No wishlist has been added</p> 
                               }
