...
import {Location} from "../compononts/location";

export const Locations:React.FC<{}>=()=>{
   
    return(
         <section className="container text-center flex flex-col h-[1100px] sm:h-[1750px] text-[4.3px] sm:text-[5px] mx-auto justify-around">
                <p className="    text-[6em]  sm:text-[7.5em] font-bold text-purple-800 underline h-[40px] sm:h-[100px]">Branch Locations</p>
                <div className="locations">
                     <div className="flex flex-col w-[50%] h-[250px] sm:h-[400px]  text-purple-800 ">
                           <p className="text-[7em] font-bold h-[50px] self-center">Cairo</p>
                           <Location location={[30.045592,31.237981]}></Location>
                     </div>
                     <div className="flex flex-col w-[50%] h-[250px] sm:h-[400px]  text-purple-800 mx-[50%]">
